										...
										<div class="agileinfo_main_grid">
											<div class="agileits_w3layouts_grid">
												...
												<select id="category1" name="c1" required="">
													...
													<option value="Kolkata">Santakruj</option> 
													<option value="Kolkata">Goa</option> 
													<option value="Kolkata">Bangoler</option> 
													<option value="Kolkata">Kashmir</option> 
													<option value="Kolkata">Maharashtra</option> 
													<option value="Kolkata">Punjab</option>   
												</select>
											</div>
										</div>
